...
**Facultate:** Facultatea de Business, Universitatea Babeș-Bolyai Cluj-Napoca

**Pagina widgetului:** https://peviitor-widget.github.io/universitatea-babes-bolyai-business/

Copiază codul de mai jos în pagina site-ului facultății, acolo unde vrei să apară widgetul:

```html
<iframe
  src="https://peviitor-widget.github.io/universitatea-babes-bolyai-business/#/widget?title=Joburi+pentru+studenti&color=%234f46e5"
  width="100%"
  height="650px"
